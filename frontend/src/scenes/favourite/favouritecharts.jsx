...
/>
      ...
      <Box
        ...
        gridAutoRows="240px"  // 2 rows
        gap="20px"
      >
        {/* ROW 1, COLUMN 1 */}
        <Box gridColumn="span 1" backgroundColor={colors.primary[400]} >
        <div className="font-inter text-base font-semibold leading-6">
 Overall Revenue Generation 
</div>

 <AreaChart data={database} width={600} height={200} />
 ...
 Daily Sales And Profits
                   ...
                   <StackedAreaChart data={data2} width={600} height={250} />
         </Box>
